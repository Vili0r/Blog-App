...
const ArticleCreate = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('/api/articles', postData)
        .then(response => { 
            Swal.fire({
                icon: 'success',
  ...
  return (
    <AppLayout>
        ...
        <section className="w-full p-6 bg-white rounded-md shadow-md m-10">
          <h2 className="text-lg font-semibold text-gray-700 capitalize mb-4">Add a new Article</h2>

          <form onSubmit={handleSubmit} encType="multipart/form-data">
              <div>
                  <label className="text-gray-700" htmlFor="title">Title</label>
                  <input id="title" name="title" type="text" onChange={onChange} className="block w-full px-4 py-2 mt-2 mb-4 text-gray-700 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring" />
              ...
              <div>
                <label className="text-gray-700" htmlFor="published_at">Date to be published</label>
                  <input id="published_at" name="published_at" type="date" onChange={onChange} value={values.published_at} className="block w-full px-4 py-2 mt-2 mb-4 text-gray-700 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring" />
